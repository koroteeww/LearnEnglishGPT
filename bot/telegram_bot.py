    ...
    async def transcribe(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        async def _execute():
            ...
            try:
                ...
                #notify
                await context.bot.send_message(chat_id=chat_id,text="Transcribe ok <"+transcript+"> wait for answer from GPT!")
                ...
                if self.config['voice_reply_transcript']:
                    ...
                    response, total_tokens, orig = await self.openai.get_chat_response(chat_id=chat_id, query=transcript)
